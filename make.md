...
2. print
    ...
    3. hand-reproducing plans from book or screen
        1. to keep drawing orthogonal, use some combination of graph paper, drafting table, and extra careful measurement and marking. An Incra ruler will help a lot with this. See above, [basics > tools](#tools) 
...
[![____plan key____](images/key.png)](http://darkroomretreat.com/img/plan/key.pdf)
...
Now that we've covered the basics that apply to all the components, let's look at those in the air, silence, and warmth department.
